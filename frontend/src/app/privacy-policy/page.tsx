...
export default function PrivacyPolicyPage() {
  return (
    <main className="min-h-dvh bg-[#0a0a14] px-6 py-12 relative overflow-hidden font-sans text-white">
      {/* Aurora glows */}
      ...
      <div className="relative w-full max-w-4xl mx-auto">
        ...
        <div className="backdrop-blur-2xl bg-[#161722]/60 border border-white/10 rounded-2xl p-8 md:p-12 shadow-2xl shadow-black/40">
          <div className="page max-w-none text-[15px] text-zinc-300 [&_h1]:text-[28px] [&_h1]:font-bold [&_h1]:text-white [&_h1]:mb-[15px] [&_h1]:mt-0 [&_h2]:text-[22px] [&_h2]:font-bold [&_h2]:text-white [&_h2]:mb-[15px] [&_h2]:mt-[30px] [&_h3]:text-[18px] [&_h3]:font-bold [&_h3]:text-white [&_h3]:mb-[10px] [&_h3]:mt-[25px] [&_h4]:text-[16px] [&_h4]:font-bold [&_h4]:text-white [&_h4]:mb-[10px] [&_h4]:mt-[20px] [&_p]:mb-[15px] [&_p]:leading-[1.6] [&_ul]:list-disc [&_ul]:pl-[40px] [&_ul]:mb-[15px] [&_li]:mb-[5px] [&_strong]:text-white [&_strong]:font-bold">
            ...
            <div className="translations-content-container">
              <div className="container">
                <div className="tab-content translations-content-item en visible" id="en">
                  ...
                  <p>We use Your Personal Data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" className="text-violet-400 hover:text-violet-300">TermsFeed Privacy Policy Generator</a>.</p>
                  ...
                  <ul>
                    ...
                    <li>
                      <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to frontend auth service.</p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p><strong>Website</strong> refers to frontend auth service, accessible from <a href="https://frontend-auth-service.up.railway.app/login" rel="external nofollow noopener" target="_blank" className="text-violet-400 hover:text-violet-300">https://frontend-auth-service.up.railway.app/login</a>.</p>
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <p>The information gathered by Google Places is held in accordance with the Privacy Policy of Google: <a href="https://www.google.com/intl/en/policies/privacy/" rel="external nofollow noopener" target="_blank" className="text-violet-400 hover:text-violet-300">https://www.google.com/intl/en/policies/privacy/</a></p>
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>By visiting this page on our website: <a href="https://frontend-auth-service.up.railway.app/login" rel="external nofollow noopener" target="_blank" className="text-violet-400 hover:text-violet-300">https://frontend-auth-service.up.railway.app/login</a></li>
                  </ul>
                </div>
              </div>
            </div>

            <div className="footer mt-12 pt-8 border-t border-white/10">
              <div className="container">
                <p className="text-sm text-zinc-500">Generated using <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank" className="text-violet-400 hover:text-violet-300">Free Privacy Policy Generator</a></p>
              </div>
            </div>
