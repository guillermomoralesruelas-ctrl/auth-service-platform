      ...
      <div className="relative w-full max-w-4xl mx-auto">
        ...
        <div className="backdrop-blur-2xl bg-[#161722]/60 border border-white/10 rounded-2xl p-8 md:p-12 shadow-2xl shadow-black/40">
          <div className="page prose prose-invert prose-zinc max-w-none">
            <h1>Privacy Policy for frontend auth service</h1>
            ...
            <ul>
              ...
              <li><p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to frontend auth service.</p></li>
              ...
              <li><p><strong>Country</strong> refers to: Mexico</p></li>
              ...
              <li><p><strong>Website</strong> refers to frontend auth service, accessible from <a href="https://frontend-auth-service.up.railway.app/login" target="_blank" rel="noopener noreferrer">https://frontend-auth-service.up.railway.app/login</a>.</p></li>
            ...
            <ul>
              <li><p><strong>With Service Providers:</strong> We may share Your Personal Data with Service Providers to monitor and analyze the use of our Service, to contact You.</p></li>
              ...
              <li><p><strong>With business partners:</strong> We may share Your Personal Data with Our business partners to offer You certain products, services or promotions.</p></li>
              <li><p><strong>With other users:</strong> If Our Service offers public areas, when You share Personal Data or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.</p></li>
            ...
            <ul>
              <li>
                ...
                <ul><li><p>User Accounts: retained for the duration of your account relationship plus up to 24 months after account closure to handle any post-termination issues or resolve disputes.</p></li></ul>
              </li>
              <li>
                <p>Customer Support Data</p>
                <ul>
                  <li><p>Support tickets and correspondence: up to 24 months from the date of ticket closure to resolve follow-up inquiries, track service quality, and defend against potential legal claims.</p></li>
                  <li><p>Chat transcripts: up to 24 months for quality assurance and staff training purposes.</p></li>
                </ul>
              </li>
              <li>
                <p>Usage Data</p>
            ...
            <ul>
              <li><p>Legal obligation: We are required by law to retain specific data (e.g., financial records for tax authorities).</p></li>
              <li><p>Legal claims: Data is necessary to establish, exercise, or defend legal claims.</p></li>
              <li><p>Your explicit request: You ask Us to retain specific information.</p></li>
              <li><p>Technical limitations: Data exists in backup systems that are scheduled for routine deletion.</p></li>
            </ul>
            ...
            <ul>
              <li><p>Deletion: Personal Data is removed from Our systems and no longer actively processed.</p></li>
              <li><p>Backup retention: Residual copies may remain in encrypted backups for a limited period consistent with our backup retention schedule and are not restored except where necessary for security, disaster recovery, or legal compliance.</p></li>
              <li><p>Anonymization: In some cases, We convert Personal Data into anonymous statistical data that cannot be linked back to You. This anonymized data may be retained indefinitely for research and analytics.</p></li>
            </ul>
            ...
            <ul>
              <li>
                ...
                <p>The information gathered by Google Places is held in accordance with the Privacy Policy of Google: <a href="https://www.google.com/intl/en/policies/privacy/" target="_blank" rel="noopener noreferrer">https://www.google.com/intl/en/policies/privacy/</a></p>
              </li>
            </ul>
            ...
            <ul>
              <li><p>By visiting this page on our website: <a href="https://frontend-auth-service.up.railway.app/login" target="_blank" rel="noopener noreferrer">https://frontend-auth-service.up.railway.app/login</a></p></li>
            </ul>
            <p className="text-sm text-zinc-500 mt-8 pt-8 border-t border-white/10">Generated using Free Privacy Policy Generator</p>
          </div>
        </div>
