        ...
        <div className="backdrop-blur-2xl bg-[#161722]/60 border border-white/10 rounded-2xl p-8 shadow-2xl shadow-black/40">
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-gradient-to-r from-violet-500 to-cyan-400 text-white rounded-lg text-sm font-semibold hover:opacity-90 shadow-lg shadow-violet-500/30 transition flex items-center justify-center h-10 disabled:opacity-70 disabled:cursor-not-allowed"
            >
